...
const PLUGIN_FILENAME = 'zs-hook.ts';
...
function buildPluginSource(hookUrl: string, token: string): string {
    ...
    return [
        '// Generated by Zhushen. Do not edit manually.',
        '',
        `const DEFAULT_HOOK_URL = ${escapedUrl};`,
        `const DEFAULT_HOOK_TOKEN = ${escapedToken};`,
        'const HOOK_URL = process.env.ZS_OPENCODE_HOOK_URL || DEFAULT_HOOK_URL;',
        'const HOOK_TOKEN = process.env.ZS_OPENCODE_HOOK_TOKEN || DEFAULT_HOOK_TOKEN;',
        '',
        ...
        '}',
        '',
        'export const ZsHookPlugin = async () => {',
        '    return {',
        '        event: async ({ event }) => {',
